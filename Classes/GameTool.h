...
public:
    ...
    static Label* addLabelDefault(Node *parent, const std::string& text, const int fontSize, Point position, Color4B color, Point anchorPoint, int zorder, const Size& dimensions = Size::ZERO, TextHAlignment hAlignment = TextHAlignment::LEFT, TextVAlignment vAlignment = TextVAlignment::BOTTOM);
    ...
    static MenuItemSprite* addItemSpriteScale(Vector<MenuItem *> *itemArray, const std::string& fileName, Point position, Point anchorPoint, const ccMenuCallback& callback);
};
